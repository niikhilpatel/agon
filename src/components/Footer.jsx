            ...
            <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8">
                <div className="lg:flex lg:items-center lg:justify-between">
                    ...
                    <div className='flex gap-5'>
                        ...
                        <button className='border mt-2 p-2 md:p-3 md:font-bold bg-black text-white'>Create an Account</button>
                    </div>
                </div>
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> +91 7880090179 </a>
                            </li>
                            ...
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> +91 8815399989 </a>
                            </li>
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> +91 7024173063 </a>
                            </li>
                        </ul>
                    </div>
